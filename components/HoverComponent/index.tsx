...
const HoverComponent = ({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'absolute -top-2 left-0 h-0 w-0 origin-[left_center_0px] scale-0 border-y-[0.5rem] border-r-[0.5rem] border-transparent transition-transform duration-100',
          active ? 'scale-100' : 'group-hover/hover:scale-100 group-hover/hover:duration-75',
        )}
      />
      <div
        className={clsx(
          'absolute inset-y-0 left-0 w-2 origin-[0px_100%_0px] scale-x-0 transition-transform duration-100',
          active ? 'scale-x-100' : 'group-hover/hover:scale-x-100 group-hover/hover:duration-75',
        )}
      />
      <div
        className={clsx(
          'absolute inset-x-0 bottom-0 h-2 origin-[0px_100%_0px] scale-y-0 transition-transform duration-100',
          active ? 'scale-y-100' : 'group-hover/hover:scale-y-100 group-hover/hover:duration-75',
        )}
      />
      <div
        className={clsx(
